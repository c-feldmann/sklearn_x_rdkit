...
class TanimotoKernel:
    ...
    @staticmethod
    def sparse_similarity(matrix_a: sparse.csr_matrix, matrix_b: sparse.csr_matrix):
    ...
    def __call__(self, matrix_a, matrix_b):
        if self.sparse_features:
            return self.sparse_similarity(matrix_a, matrix_b)
        else:
...
def tanimoto_from_sparse(matrix_a: sparse.csr_matrix, matrix_b: sparse.csr_matrix):
    ...
    return TanimotoKernel.sparse_similarity(matrix_a, matrix_b)
